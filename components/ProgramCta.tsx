...
import { Trophy, Target, Users, Camera, Zap } from "lucide-react";

export const metadata: Metadata = {
  title: "Tekmovalne ekipe | Alpska šola Rogla",
  description:
    "Tekmovalne ekipe U6–U12 Alpske šole — resni treningi, slovenski in regijski pokal. Za najbolj predane mlade smučarje.",
};
...
const lastnosti = [
  ...
  },
  {
    ...
    text: "Slovenski pokal in regijski pokal Vzhodne regije.",
  },
  {
    icon: Zap,
    title: "Koroški pokal",
    text: "Sodelovanje v regijski tekmovalni seriji.",
  },
  {
    icon: Users,
        ...
        <div className="max-w-5xl mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-slate-600 leading-relaxed">
              Pod vodstvom izkušenih trenerjev{" "}
              <strong>Nejca Cilenška in Claudia Seidl</strong> razvijamo tehniko,
              kondicijo in tekmovalno mentaliteto naših mladih tekmovalcev.
            </p>
          </div>
          <div className="rounded-2xl overflow-hidden shadow-2xl shadow-brand-navy/10 aspect-video">
            <img src="/tekmovalnaslika.jpg" alt="Tekmovalne ekipe" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
